...
$(BUILD_DIR)/PyDecoder$(SUFFIX): $(BUILD_DIR)/PyDecoder.o $(BUILD_DIR)/CPUDecoder.o $(BUILD_DIR)/GPUDecoder.o $(BUILD_DIR)/NvDecoder.o $(BUILD_DIR)/DeviceChecker.o $(BUILD_DIR)/ColorSpace.o
